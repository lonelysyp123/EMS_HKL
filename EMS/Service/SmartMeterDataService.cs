...
namespace EMS.Service
{
    public class SmartMeterDataService : DataServiceBase<SmartMeterModel>
    {
        ...
        byte[] Response_GetCurrent_A =      
            new byte[] { 0xFE, 0xFE, 0xFE, 0xFE,
                         0x68, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0x68, 0x91, 0x06, 0x33, 0x34, 0x35, 0x35, 0x00, 0x00, 0x00, 0x16 };
        ...
        byte[] Response_GetCurrent_B =      
            new byte[] { 0xFE, 0xFE, 0xFE, 0xFE,
                         0x68, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0x68, 0x91, 0x06, 0x33, 0x35, 0x35, 0x35, 0x00, 0x00, 0x00, 0x16 };
        ...
        byte[] Response_GetCurrent_C =      
            new byte[] { 0xFE, 0xFE, 0xFE, 0xFE,
                         0x68, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0x68, 0x91, 0x06, 0x33, 0x36, 0x35, 0x35, 0x00, 0x00, 0x00, 0x16 };
        ...
        byte[] Response_GetActivePower_A =  
            new byte[] { 0xFE, 0xFE, 0xFE, 0xFE,
                         0x68, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0x68, 0x91, 0x06, 0x33, 0x34, 0x36, 0x35, 0x00, 0x00, 0x00, 0x16 };
        ...
        byte[] Response_GetActivePower_B = 
            new byte[] { 0xFE, 0xFE, 0xFE, 0xFE,
                         0x68, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0x68, 0x91, 0x06, 0x33, 0x35, 0x36, 0x35, 0x00, 0x00, 0x00, 0x16 };
        ...
        byte[] Response_GetActivePower_C = 
            new byte[] { 0xFE, 0xFE, 0xFE, 0xFE,
                         0x68, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0x68, 0x91, 0x06, 0x33, 0x36, 0x36, 0x35, 0x00, 0x00, 0x00, 0x16 };
        ...
        byte[] Response_GetActivePower_Total =
            new byte[] { 0xFE, 0xFE, 0xFE, 0xFE,
                         0x68, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0x68, 0x91, 0x06, 0x33, 0x33, 0x36, 0x35, 0x00, 0x00, 0x00, 0x16 };
        ...
        byte[] Response_GetReactivePower_A =
            new byte[] { 0xFE, 0xFE, 0xFE, 0xFE,
                         0x68, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0x68, 0x91, 0x06, 0x33, 0x34, 0x37, 0x35, 0x00, 0x00, 0x00, 0x16 };
        ...
        byte[] Response_GetReactivePower_B =
            new byte[] { 0xFE, 0xFE, 0xFE, 0xFE,
                         0x68, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0x68, 0x91, 0x06, 0x33, 0x35, 0x37, 0x35, 0x00, 0x00, 0x00, 0x16 };
        ...
        byte[] Response_GetReactivePower_C =
            new byte[] { 0xFE, 0xFE, 0xFE, 0xFE,
                         0x68, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0x68, 0x91, 0x06, 0x33, 0x36, 0x37, 0x35, 0x00, 0x00, 0x00, 0x16 };
        ...
        byte[] Response_GetReactivePower_Total =
            new byte[] { 0xFE, 0xFE, 0xFE, 0xFE,
                         0x68, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0xAA, 0x68, 0x91, 0x06, 0x33, 0x33, 0x37, 0x35, 0x00, 0x00, 0x00, 0x16 };
        ...
        private bool CheckData(byte[] standardBytes, byte[] readBytes)
        {
            ...
            {
                for (int i = 11; i < standardBytes.Length - 4; i++)
                {
